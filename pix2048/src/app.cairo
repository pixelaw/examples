...
trait INumberActions<TContractState> {
    ...
    // fn get_digits(self: @TContractState, default_params: DefaultParameters, number: u32) -> u32;
    // fn get_power(self: @TContractState, default_params: DefaultParameters, base: u32, power: u32) -> u32;
    // fn to_short_string(self: @TContractState, default_params: DefaultParameters, number: u32) -> felt252;
}
...
use core::array::ArrayTrait;
    ...
    use super::{APP_KEY, APP_ICON, APP_MANIFEST, NumberGame, State, NumberGameField, NumberValue};
    use pixelaw::core::utils::{get_core_actions, Direction, Position, DefaultParameters};
            ...
            loop{
				...
				loop {
                    ...
                    set!(
                        world,
                        (NumberValue {
                            x: position.x + j, y: position.y + i, value: 0
                        })
                    );
                    j += 1;
                };
        ...
        fn gen_random(self: @ContractState, default_params: DefaultParameters){
            ...
            loop{
				...
				loop {
                    ...
                    let mut nv = get!(world, (origin_position.x+j, origin_position.y+i), NumberValue);
                    if nv.value=='' {
            ...
            set!(
                world,
                (NumberValue {
                    x: origin_position.x + (*zero_index.at(random_zero_index_len)%4), y: origin_position.y + (*zero_index.at(random_zero_index_len)/4), value: gen_num
                })
            );
            core_actions.update_pixel(
                player,
        ...
        fn move_right(self: @ContractState, default_params: DefaultParameters){
            ...
            loop{
                ...
                set!(
                    world,
                    (NumberValue {
                        x: origin_position.x + i%4, y: origin_position.y + i/4, value: matrix_num
                    })
                );
                core_actions.update_pixel(
                player,
                ...
                PixelUpdate{
                    ...
                    color: Option::Some(get_color(matrix_num)), //should I pass in a color to define the minesweepers field color?
                    timestamp: Option::None,
